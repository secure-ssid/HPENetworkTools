/**
 * web/src/screens/pathFor.test.ts — the shared client path-chain builder.
 *
 * Named for what it tests. It sat as SiteTopology.test.ts, beside a
 * SiteTopology.tsx it never touched, which made the screen's own builder look
 * covered when nothing tested it at all.
 */
